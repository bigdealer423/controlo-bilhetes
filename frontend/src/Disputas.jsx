...
export default function Disputas() {
    ...
    <h1 className="text-xl font-bold mb-4 text-gray-800 dark:text-white">🛡️ Disputas</h1>
    <table className="min-w-full border dark:border-gray-700 text-sm">
        <thead className="bg-gray-100 dark:bg-gray-800">
            <tr>
                <th className="p-2 border text-gray-800 dark:text-gray-200 dark:border-gray-700">ID</th>
                <th className="p-2 border text-gray-800 dark:text-gray-200 dark:border-gray-700">Evento</th>
                <th className="p-2 border text-gray-800 dark:text-gray-200 dark:border-gray-700">Ganho</th>
                <th className="p-2 border text-gray-800 dark:text-gray-200 dark:border-gray-700">Estado</th>
                <th className="p-2 border text-gray-800 dark:text-gray-200 dark:border-gray-700">Notas</th>
                <th className="p-2 border text-gray-800 dark:text-gray-200 dark:border-gray-700">Ficheiros</th>
            </tr>
        </thead>
        <tbody>
            {disputas.map((d) => (
                <tr key={d.id} className="hover:bg-gray-100 dark:hover:bg-gray-800">
                    <td className="p-2 border text-gray-800 dark:text-gray-200 dark:border-gray-700">{d.id}</td>
                    <td className="p-2 border text-gray-800 dark:text-gray-200 dark:border-gray-700">{d.evento}</td>
                    <td className="p-2 border text-gray-800 dark:text-gray-200 dark:border-gray-700">{d.ganho}€</td>
                    <td className="p-2 border dark:border-gray-700">
                        <select
                            value={d.estado}
                            onChange={(e) => atualizarEstado(d.id, e.target.value)}
                            className="p-1 rounded bg-white dark:bg-gray-700 text-gray-800 dark:text-white border dark:border-gray-600"
                        >
                    ...
                    <td className="p-2 border dark:border-gray-700">
                        <Popover>
                            ...
                            <PopoverContent className="p-2 bg-white dark:bg-gray-900 border dark:border-gray-700 w-72">
                                ...
                                />
                                <div className="mb-2">
                                    <label className="block text-sm mb-1 text-gray-800 dark:text-gray-200">Etiquetas:</label>
                                    <select
                                        multiple
