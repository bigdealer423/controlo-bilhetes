...
from playwright.async_api import async_playwright  # <- usa versão assíncrona
...
async def obter_preco_com_playwright(base_url: str, setor: str, quantidade: int):
    ...
    async with async_playwright() as p:
        browser = await p.firefox.launch(headless=True)  # ← usar Firefox
